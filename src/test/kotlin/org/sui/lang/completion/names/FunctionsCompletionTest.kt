...
class FunctionsCompletionTest : CompletionTestCase() {
    ...
    fun `test public entry completions for script`() = completionFixture.checkContainsCompletion(
        """
        address 0x1 {
        module Transaction {
            friend 0x1::M;
    ...
    """, listOf("create", "create_entry", "create_friend", "create_private")
    )
