...
class ResolveFunctionTest : ResolveTestCase() {
    ...
    fun `test resolve entry function`() = checkByCode(
        """
        address 0x1 {
        module Original {
    ...
    fun `test public entry function can call public entry from another module`() = checkByCode(
        """
        address 0x1 {
        module Original {
            public entry fun call() {}
    ...
    fun `test public entry function can be resolved from import`() = checkByCode(
        """
    module 0x1::M {
        public entry fun call() {}
                         //X
    ...
    fun `test public entry function available in test`() = checkByCode(
        """
    module 0x1::M {
        public entry fun call() {}
                         //X
    ...
    fun `test public entry function available in entry function`() = checkByCode(
        """
module 0x1::M {
    public entry fun call() {}
                    //X
...
"""
    ...
    fun `test public entry function available in another public entry function`() = checkByCode(
        """
module 0x1::M {
    public entry fun call() {}
                    //X
