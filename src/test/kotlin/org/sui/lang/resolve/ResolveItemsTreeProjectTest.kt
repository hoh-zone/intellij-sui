...
class ResolveItemsTreeProjectTest : ResolveProjectTestCase() {
    ...
    fun `test resolve module from git transitive dependency`() = checkByFileTree {
        dotMove {
            git("https://github.com/MystenLabs/sui-stdlib.git", "main") {
                moveToml(
                    """
        [package]
        name = "SuiStdlib"        
        [dependencies]
        MoveStdlib = { git = "https://github.com/MystenLabs/move-stdlib.git", rev = "main" }                        
                """
                )
            }
            git("https://github.com/MystenLabs/move-stdlib.git", "main") {
                moveToml(
                    """
        [package]
        name = "MoveStdlib"        
        ...
        name = "MyModule"        
        [dependencies]
        SuiStdlib = { git = "https://github.com/MystenLabs/sui-stdlib.git", rev = "main" }    
        """
        )
        sources {
            move(
...
//                    #[test]
//                    #[expected_failure(abort_code = 1, location = sui::account)]
//                                                                                  //^
//                    fun test_abort() {
//
//                    }
