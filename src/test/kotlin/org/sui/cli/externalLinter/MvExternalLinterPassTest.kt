...
import org.sui.utils.tests.WithSuiCliTestBase

class MvExternalLinterPassTest : WithSuiCliTestBase() {
    ...
    fun `test type error`() = doTest(
        ...
        module 0x1::main {
            fun main() {
                1 <error descr="${MvExternalLinterUtils.TEST_MESSAGE}">+</error> true/*caret*/
            }
        }
    """
    )
...
//    """)
    ...
    private fun doTest(
        @Language("Sui Move") mainMove: String,
