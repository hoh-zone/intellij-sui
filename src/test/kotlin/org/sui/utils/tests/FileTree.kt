...
import org.sui.utils.tests.FilesystemEntry.Directory
import org.sui.utils.tests.FilesystemEntry.File
import org.sui.utils.tests.resolve.TestResolveResult
import org.sui.utils.tests.resolve.checkResolvedFile
...
interface FileTreeBuilder {
    ...
    fun git(repo: String, rev: String, builder: TreeBuilder = {}) {
        val dirName = TomlDependency.Git.dirNameSui(repo, rev)
