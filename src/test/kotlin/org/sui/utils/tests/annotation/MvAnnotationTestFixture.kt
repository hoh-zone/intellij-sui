...
//        IndexingTestUtil.waitUntilIndexesAreReady(codeInsightFixture.project)
    ...
    fun registerSeverities(severities: List<HighlightSeverity>) {
        // Note: Custom severity registration is handled differently in newer IntelliJ versions
        // This method is kept for API compatibility but may need updates for specific severity features
    }
