...
//    """)
    ...
    fun `test rename signer in test function`() = doTest(
        "new_acc", """
    module 0x1::M {
        #[test(acc = @0x1)]
    ...
    fun `test rename function argument in specs`() = doTest(
        "new_name", """
    module 0x1::main {
    ...
    fun `test rename function argument in module specs`() = doTest(
        "new_name", """
    module 0x1::main {
        fun call(/*caret*/old_name: bool) {}
    }
    ...
    fun `test rename shorthand into non-shorthand`() = doTest(
        "new_val", """
    module 0x1::main {
        struct S { val: u8 }
    ...
    fun `test rename parameter field init shorthand replaced`() = doTest(
        "self", """
        module 0x1::main {
