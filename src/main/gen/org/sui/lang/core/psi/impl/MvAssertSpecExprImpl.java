...
public class MvAssertSpecExprImpl extends MvExprImpl implements MvAssertSpecExpr {

  public MvAssertSpecExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MvVisitor visitor) {
    visitor.visitAssertSpecExpr(this);
  }
