...
public class MvVectorLitItemsImpl extends MvElementImpl implements MvVectorLitItems {

  public MvVectorLitItemsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MvVisitor visitor) {
    visitor.visitVectorLitItems(this);
  }
