...
public class MvModuleItemSpecImpl extends MvElementImpl implements MvModuleItemSpec {

  public MvModuleItemSpecImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MvVisitor visitor) {
    visitor.visitModuleItemSpec(this);
  }
