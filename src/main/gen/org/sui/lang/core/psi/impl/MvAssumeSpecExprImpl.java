...
public class MvAssumeSpecExprImpl extends MvExprImpl implements MvAssumeSpecExpr {

  public MvAssumeSpecExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MvVisitor visitor) {
    visitor.visitAssumeSpecExpr(this);
  }
