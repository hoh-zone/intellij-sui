...
public class MvForIterConditionImpl extends MvElementImpl implements MvForIterCondition {

  public MvForIterConditionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MvVisitor visitor) {
    visitor.visitForIterCondition(this);
  }
