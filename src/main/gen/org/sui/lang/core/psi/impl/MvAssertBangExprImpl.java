...
public class MvAssertBangExprImpl extends MvExprImpl implements MvAssertBangExpr {

  public MvAssertBangExprImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MvVisitor visitor) {
    visitor.visitAssertBangExpr(this);
  }
