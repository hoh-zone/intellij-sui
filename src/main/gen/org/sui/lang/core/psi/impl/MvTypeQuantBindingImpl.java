...
public class MvTypeQuantBindingImpl extends MvQuantBindingImpl implements MvTypeQuantBinding {

  public MvTypeQuantBindingImpl(ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MvVisitor visitor) {
    visitor.visitTypeQuantBinding(this);
  }
