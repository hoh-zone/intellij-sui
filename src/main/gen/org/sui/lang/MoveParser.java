...
public class MoveParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(EXPR_STMT, LET_STMT, STMT, USE_STMT),
    ...
    create_token_set_(ABORT_EXPR, ANNOTATED_EXPR, ASSERT_BANG_EXPR, ASSERT_MACRO_EXPR,
      ASSIGNMENT_EXPR, BANG_EXPR, BINARY_EXPR, BORROW_EXPR,
      BREAK_EXPR, CALL_EXPR, CAST_EXPR, CODE_BLOCK_EXPR,
      CONTINUE_EXPR, COPY_EXPR, DEREF_EXPR, DOT_EXPR,
      EXPR, FOR_EXPR, IF_EXPR, INDEX_EXPR,
      LABELED_BLOCK_EXPR, LAMBDA_EXPR, LIT_EXPR, LOOP_EXPR,
      MATCH_EXPR, MOVE_EXPR, PARENS_EXPR, PATH_EXPR,
      RANGE_EXPR, REF_EXPR, RETURN_EXPR, STRUCT_LIT_EXPR,
      TUPLE_LIT_EXPR, UNIT_LIT_EXPR, VECTOR_LIT_EXPR, WHILE_EXPR),
  };
  ...
  public static boolean AddressRef(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = consumeToken(builder_, SUI_ADDRESS);
  ...
  /* ********************************************************** */
  // ':' Type ')'
  public static boolean AnnotatedExprUpper(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "AnnotatedExprUpper")) return false;
    if (!nextTokenIs(builder_, COLON)) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _UPPER_, ANNOTATED_EXPR, null);
  ...
  /* ********************************************************** */
  // Attr* IDENTIFIER ( BlockFields | TupleFields )?
  ...
  private static boolean EnumVariant_2(PsiBuilder builder_, int level_) {
    ...
    EnumVariant_2_0(builder_, level_ + 1);
    return true;
  }

  // BlockFields | TupleFields
  private static boolean EnumVariant_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "EnumVariant_2_0")) return false;
    boolean result_;
  ...
  public static boolean EnumVariantPat(PsiBuilder builder_, int level_) {
    ...
    result_ = PathImpl(builder_, level_ + 1);
    result_ = result_ && PatTuple(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  /* ********************************************************** */
  // let | if | while | loop | continue | break | return
  //                         | copy | move | abort
  //                         | IDENTIFIER
  //                         | QUOTE_IDENTIFIER
  //                         | '*' | '&' | '!' | '|' | '{' | '('
  ...
  static boolean IndexArg_items(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && IndexArg_items_2(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  // ','?
  private static boolean IndexArg_items_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "IndexArg_items_2")) return false;
    consumeToken(builder_, COMMA);
    return true;
  }
  ...
  public static boolean LambdaParam(PsiBuilder builder_, int level_) {
    ...
    result_ = MatchPat(builder_, level_ + 1);
    pinned_ = result_; // pin = 1
  ...
  /* ********************************************************** */
  // Attr* MatchPatList MatchArmGuard? '=>' Expr ','?
  public static boolean MatchArm(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && MatchPatList(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
  ...
  public static boolean MatchPat(PsiBuilder builder_, int level_) {
    ...
    result_ = EnumVariantPat(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // MatchPat ('|' MatchPat)*
  static boolean MatchPatList(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "MatchPatList")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = MatchPat(builder_, level_ + 1);
    result_ = result_ && MatchPatList_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // ('|' MatchPat)*
  private static boolean MatchPatList_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "MatchPatList_1")) return false;
    while (true) {
      int pos_ = current_position_(builder_);
      if (!MatchPatList_1_0(builder_, level_ + 1)) break;
      if (!empty_element_parsed_guard_(builder_, "MatchPatList_1", pos_)) break;
    }
    return true;
  }

  // '|' MatchPat
  private static boolean MatchPatList_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "MatchPatList_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = consumeToken(builder_, OR);
    result_ = result_ && MatchPat(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }
  ...
  /* ********************************************************** */
  // use | public | native | fun | CONST_KW | STRUCT_KW
  ...
  public static boolean PatWild(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, PAT_WILD, "<pat wild>");
    result_ = underscore_pat(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  /* ********************************************************** */
  // underscore_pat | '(' | Path_first | AnyLitToken_first | mut
  ...
  public static boolean PathAddress(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, SUI_ADDRESS);
    if (!result_) result_ = consumeToken(builder_, INTEGER_LITERAL);
    if (!result_) result_ = consumeToken(builder_, PLACEHOLDER_ADDRESS);
    if (!result_) result_ = consumeToken(builder_, BECH32_ADDRESS);
    if (!result_) result_ = consumeToken(builder_, POLKADOT_ADDRESS);
  ...
  /* ********************************************************** */
  // IDENTIFIER | QUOTE_IDENTIFIER | PATH_MODE_IDENTIFIER
  static boolean PathIdent(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = PATH_MODE_IDENTIFIER(builder_, level_ + 1);
    return result_;
  }
  ...
  public static boolean PathStart(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && PathStart_2(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  private static boolean PathStart_1(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = PathStart_1_0(builder_, level_ + 1);
  ...
  // PathAddress &'::'
  private static boolean PathStart_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "PathStart_1_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = PathAddress(builder_, level_ + 1);
    result_ = result_ && PathStart_1_0_1(builder_, level_ + 1);
    exit_section_(builder_, marker_, null, result_);
    return result_;
  }

  // &'::'
  private static boolean PathStart_1_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "PathStart_1_0_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _AND_);
    result_ = consumeToken(builder_, COLON_COLON);
    exit_section_(builder_, level_, marker_, result_, false, null);
  ...
  // TypeArgumentList?
  private static boolean PathStart_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "PathStart_2")) return false;
    TypeArgumentList(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // PATH_MODE_IDENTIFIER | SUI_ADDRESS | INTEGER_LITERAL | '::'
  static boolean Path_first(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = consumeTokenFast(builder_, SUI_ADDRESS);
    if (!result_) result_ = consumeTokenFast(builder_, INTEGER_LITERAL);
  ...
  /* ********************************************************** */
  // fun PathImpl 'as' UseFunMethodAlias
  public static boolean UseFunAlias(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "UseFunAlias")) return false;
    if (!nextTokenIs(builder_, FUN)) return false;
    boolean result_, pinned_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, USE_FUN_ALIAS, null);
    result_ = consumeToken(builder_, FUN);
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, PathImpl(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, "as")) && result_;
    result_ = pinned_ && UseFunMethodAlias(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }

  /* ********************************************************** */
  // (PathImpl '.' IDENTIFIER) | IDENTIFIER
  public static boolean UseFunMethodAlias(PsiBuilder builder_, int level_) {
    ...
    result_ = UseFunMethodAlias_0(builder_, level_ + 1);
    if (!result_) result_ = consumeToken(builder_, IDENTIFIER);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  // PathImpl '.' IDENTIFIER
  private static boolean UseFunMethodAlias_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "UseFunMethodAlias_0")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_);
    result_ = PathImpl(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // Attr* 'public'? use ( UseFunAlias | UseSpeck ) ';'
  public static boolean UseStmt(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && UseStmt_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, USE);
    pinned_ = result_; // pin = use
    result_ = result_ && report_error_(builder_, UseStmt_3(builder_, level_ + 1));
    result_ = pinned_ && consumeToken(builder_, SEMICOLON) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }
  ...
  // UseFunAlias | UseSpeck
  private static boolean UseStmt_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "UseStmt_3")) return false;
    boolean result_;
    result_ = UseFunAlias(builder_, level_ + 1);
    if (!result_) result_ = UseSpeck(builder_, level_ + 1);
    return result_;
  }
  ...
  public static boolean WildType(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _COLLAPSE_, WILD_TYPE, "<wild type>");
    result_ = underscore_pat(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }
  ...
  /* ********************************************************** */
  // <<underscorePat>>
  static boolean underscore_pat(PsiBuilder builder_, int level_) {
    return underscorePat(builder_, level_ + 1);
  }
  ...
  // 2: BINARY(OrBinExpr)
  // 3: BINARY(AndBinExpr)
  // 4: BINARY(EqualsBinExpr) BINARY(NotEqualsBinExpr) BINARY(LessEqualsBinExpr) BINARY(LessBinExpr)
  //    BINARY(GreaterEqualsBinExpr) BINARY(GreaterBinExpr)
  // 5: BINARY(BitOrBinExpr)
  // 6: BINARY(BitXorBinExpr)
  // 7: BINARY(BitAndBinExpr)
  // 8: BINARY(LeftShiftBinExpr)
  // 9: BINARY(RightShiftBinExpr)
  // 10: BINARY(PlusBinExpr) BINARY(MinusBinExpr)
  // 11: BINARY(DivBinExpr) BINARY(MulBinExpr) BINARY(ModBinExpr)
  // 12: POSTFIX(CastExpr)
  // 13: ATOM(IfExpr) ATOM(LoopExpr) ATOM(MatchExpr) ATOM(WhileExpr)
  //    ATOM(ForExpr) ATOM(LabeledBlockExpr)
  // 14: PREFIX(CopyExpr) PREFIX(MoveExpr) PREFIX(DerefExpr) PREFIX(BangExpr)
  //    ATOM(ReturnExpr) ATOM(ContinueExpr) ATOM(BreakExpr) ATOM(AbortExpr)
  // 15: PREFIX(BorrowExpr)
  // 16: ATOM(TupleLitOrParenExpr) ATOM(UnitLitExpr) ATOM(StructLitExpr) ATOM(PathExpr)
  //    ATOM(CallExpr) POSTFIX(DotExpr) POSTFIX(IndexExpr) ATOM(VectorLitExpr)
  ...
  public static boolean Expr_0(PsiBuilder builder_, int level_, int priority_) {
    ...
    while (true) {
      ...
      else if (priority_ < 2 && OrBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 2);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 3 && AndBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 3);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 4 && EqualsBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 4);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 4 && NotEqualsBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 4);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 4 && LessEqualsBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 4);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 4 && LessBinExpr_0(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 4);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 4 && GreaterEqualsBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 4);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 4 && GreaterBinExpr_0(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 4);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 5 && BitOrBinExpr_0(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 5);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 6 && BitXorBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 6);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 7 && BitAndBinExpr_0(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 7);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 8 && LeftShiftBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 8);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 9 && RightShiftBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 9);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 10 && PlusBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 10);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 10 && MinusBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 10);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 11 && DivBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 11);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 11 && MulBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 11);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 11 && ModBinOp(builder_, level_ + 1)) {
        result_ = Expr(builder_, level_, 11);
        exit_section_(builder_, level_, marker_, BINARY_EXPR, result_, true, null);
      }
      else if (priority_ < 12 && CastExpr_0(builder_, level_ + 1)) {
        result_ = true;
        exit_section_(builder_, level_, marker_, CAST_EXPR, result_, true, null);
      }
      else if (priority_ < 16 && DotExpr_inner(builder_, level_ + 1)) {
        result_ = true;
        exit_section_(builder_, level_, marker_, DOT_EXPR, result_, true, null);
      }
      else if (priority_ < 16 && IndexArg(builder_, level_ + 1)) {
        result_ = true;
  ...
  public static boolean AbortExpr(PsiBuilder builder_, int level_) {
    ...
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NONE_, ABORT_EXPR, "<expression>");
    result_ = consumeTokenSmart(builder_, ABORT);
    result_ = result_ && AbortExpr_1(builder_, level_ + 1);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // Expr?
  private static boolean AbortExpr_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "AbortExpr_1")) return false;
    Expr(builder_, level_ + 1, -1);
    return true;
  }
  ...
  // '(' !')' Expr (TupleLitExprUpper | AnnotatedExprUpper | ')')
  public static boolean TupleLitOrParenExpr(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && TupleLitOrParenExpr_1(builder_, level_ + 1);
    pinned_ = result_; // pin = 2
    result_ = result_ && report_error_(builder_, Expr(builder_, level_ + 1, -1));
    result_ = pinned_ && TupleLitOrParenExpr_3(builder_, level_ + 1) && result_;
    exit_section_(builder_, level_, marker_, result_, pinned_, null);
    return result_ || pinned_;
  }

  // !')'
  private static boolean TupleLitOrParenExpr_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "TupleLitOrParenExpr_1")) return false;
    boolean result_;
    Marker marker_ = enter_section_(builder_, level_, _NOT_);
    result_ = !consumeTokenSmart(builder_, R_PAREN);
    exit_section_(builder_, level_, marker_, result_, false, null);
    return result_;
  }

  // TupleLitExprUpper | AnnotatedExprUpper | ')'
  private static boolean TupleLitOrParenExpr_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "TupleLitOrParenExpr_3")) return false;
    boolean result_;
    result_ = TupleLitExprUpper(builder_, level_ + 1);
    if (!result_) result_ = AnnotatedExprUpper(builder_, level_ + 1);
