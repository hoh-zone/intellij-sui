...
import org.sui.ide.notifications.MvExternalLinterSlowRunNotifier
import org.sui.lang.MoveFile
import org.sui.lang.core.psi.ext.findMoveProject
import org.sui.openapiext.common.isUnitTestMode

class MvExternalLinterPass(
    private val factory: MvExternalLinterPassFactory,
    ...
    @Volatile
    private var annotationInfo: Lazy<MvExternalLinterResult?>? = null
    private val annotationResult: MvExternalLinterResult? get() = annotationInfo?.value
    ...
    override fun doCollectInformation(progress: ProgressIndicator) {
        ...
        annotationInfo = MvExternalLinterUtils.checkLazily(
            sui,
            myProject,
        ...
        class MvUpdate: Update(file) {
            ...
            override fun run() {
                BackgroundTaskUtil.runUnderDisposeAwareIndicator(disposable, Runnable {
                    ...
                    myProject.service<MvExternalLinterSlowRunNotifier>()
            ...
            override fun canEat(update: Update): Boolean = updateFile == (update as? MvUpdate)?.updateFile
        }
    ...
    private fun doApply(annotationResult: MvExternalLinterResult) {
    ...
    companion object {
        private val LOG: Logger = logger<MvExternalLinterPass>()
    }
}

class MvExternalLinterPassFactory(
    project: Project,
    ...
    override fun createHighlightingPass(file: PsiFile, editor: Editor): TextEditorHighlightingPass? {
        ...
        return MvExternalLinterPass(this, file, editor)
    }
