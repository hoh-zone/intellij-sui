...
package org.sui.ide.formatter.blocks

import com.intellij.formatting.*
import com.intellij.lang.ASTNode
import com.intellij.openapi.util.TextRange
import org.sui.ide.formatter.MvFmtContext
import org.sui.ide.formatter.impl.computeSpacing
...
class SyntheticMvFmtBlock(
    ...
    private fun findFirstNonSyntheticChild(): ASTNode? {
        return when (val child = subBlocks.first()) {
            is SyntheticMvFmtBlock -> child.findFirstNonSyntheticChild()
