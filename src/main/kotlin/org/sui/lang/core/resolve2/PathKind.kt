...
sealed class PathKind {
    ...
    // sui:: where sui is a existing named address in a project
    ...
    sealed class QualifiedPath(
        ...
        // `0x1:foo` or `sui::foo` (where sui is known named address)
        ...
        // bar in `0x1::foo::bar` or `sui::foo::bar` (where sui is known named address)
