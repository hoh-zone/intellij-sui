...
package org.sui.lang.core.completion.sort

import com.intellij.codeInsight.lookup.LookupElement
import com.intellij.codeInsight.lookup.LookupElementWeigher
import org.sui.lang.core.completion.LookupElementProperties
import org.sui.lang.core.completion.MvLookupElement
    ...
    for (weigherOrAnchor in weighersWithAnchors.asSequence().drop(1)
        ...
        when (weigherOrAnchor) {
            ...
            is MvCompletionWeigher -> {
                ...
                currentWeighers += MvCompletionWeigherAsLookupElementWeigher(weigherOrAnchor)
            }
            else -> error(
...
private class MvCompletionWeigherAsLookupElementWeigher(
