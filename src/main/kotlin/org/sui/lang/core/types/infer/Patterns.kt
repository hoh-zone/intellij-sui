...
import org.sui.lang.core.psi.ext.MvBindingModeKind.BindByReference
import org.sui.lang.core.psi.ext.MvBindingModeKind.BindByValue
...
fun MvPat.extractBindings(fcx: TypeInferenceWalker, ty: Ty, defBm: MvBindingModeKind = BindByValue) {
    val msl = this.isMsl()
    when (this) {
...
private fun Ty.applyBm(defBm: MvBindingModeKind, msl: Boolean): Ty =
    if (defBm is BindByReference) TyReference(this, defBm.mutability, msl) else this

private fun Ty.stripReferences(defBm: MvBindingModeKind): Pair<Ty, MvBindingModeKind> {
    var bm = defBm
    var ty = this
