    ...
    private fun <T: MvElement> instantiateTypeParamsSubstitution(
        ...
        for ((param, value) in psiSubstitution.typeSubst.entries) {
            ...
            val valueTy = when (value) {
                is MvPsiSubstitution.Value.Present -> lowerTy(value.value, msl)
                is MvPsiSubstitution.Value.OptionalAbsent -> paramTy
                is MvPsiSubstitution.Value.RequiredAbsent -> TyUnknown
            }
