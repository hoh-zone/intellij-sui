...
import org.sui.utils.ui.MoveTextFieldWithCompletion
import org.sui.utils.ui.hasParseErrors
    ...
    private fun createInnerPanel(): JPanel {
        ...
        return panel {
            ...
            val parameters = function
                ?.let { commandHandler.getFunctionParameters(function) }
                .orEmpty()
            ...
            if (parameters.isNotEmpty()) {
                for (parameter in parameters) {
                    ...
                    val paramTyName = parameter.typeAnnotation?.type?.text ?: "unknown"
                    row(paramName) {
                        comment(": $paramTyName")
                        val paramField = textField()
