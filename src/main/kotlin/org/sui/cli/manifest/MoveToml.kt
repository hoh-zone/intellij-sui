...
//            }
        ...
        fun fromBuildInfo(tomlFile: TomlFile,depMoveToml:MoveToml): MoveToml {
            ...
            val compiled_package_info = (yaml["compiled_package_info"] as? Map<String, *>)?: return depMoveToml
            val build_flags = (compiled_package_info["build_flags"] as? Map<String, *> )?: return depMoveToml

            val implicit_dependencies = findGitByName(build_flags,"implicit_dependencies")?: return depMoveToml
            val dependencies = mutableListOf<Pair<TomlDependency, RawAddressMap>>()
            implicit_dependencies.forEach{
...
//            val Sui = findGitByName(build_flags,"Sui")?: return null
            val Git= findGitByName(depMap,"Git")?: return null

            val git_url = Git["git_url"] as? String?: return null
            val git_rev = Git["git_rev"] as? String?: return null
            val git_subdir = Git["subdir"] as? String?: return null
            val subst = mutableRawAddressMap()
            return Pair(
                TomlDependency.Git(
                    depName,
