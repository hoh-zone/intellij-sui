...
import org.sui.ide.notifications.MvExternalLinterTooltipService
import org.sui.openapiext.showSettingsDialog
import java.awt.event.MouseEvent
import javax.swing.JComponent

class MvExternalLinterWidgetFactory : StatusBarWidgetFactory {
    override fun getId(): String = MvExternalLinterWidget.ID
    ...
    override fun createWidget(project: Project): StatusBarWidget = MvExternalLinterWidget(project)
    override fun disposeWidget(widget: StatusBarWidget) = Disposer.dispose(widget)
    override fun canBeEnabledOn(statusBar: StatusBar): Boolean = true
}

class MvExternalLinterWidgetUpdater(private val project: Project) : MoveProjectsService.MoveProjectsListener {
    override fun moveProjectsUpdated(service: MoveProjectsService, projects: Collection<MoveProject>) {
        ...
        manager.updateWidget(MvExternalLinterWidgetFactory::class.java)
    }
}

class MvExternalLinterWidget(private val project: Project) : TextPanel.WithIconAndArrows(),
    ...
    override fun install(statusBar: StatusBar) {
        ...
        if (!project.isDisposed) {
            ...
            project.service<MvExternalLinterTooltipService>().showTooltip(this)
        }
