...
SUI_ADDRESS=0x[0-9a-fA-F_]{1,127}
...
INTEGER_LITERAL=[0-9][0-9_]*({INT_SUFFIX})?
HEX_INTEGER_LITERAL=0x[0-9a-fA-F][0-9a-fA-F_]*({INT_SUFFIX})?
...
<YYINITIAL> {
  ...
  {SUI_ADDRESS}          { return SUI_ADDRESS; }
